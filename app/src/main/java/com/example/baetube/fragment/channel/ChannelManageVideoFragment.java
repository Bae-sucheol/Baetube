...
public class ChannelManageVideoFragment extends Fragment implements OnRecyclerViewClickListener
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        // 리사이클러뷰 요소 찾기
        recyclerViewCategory = view.findViewById(R.id.fragment_channel_manage_video_recyclerview_category);
    ...
    public void onViewCreated( View view, @Nullable Bundle savedInstanceState)
    {
        ...
        String videoUrl = getString(R.string.api_url_video_channel) + channelId;
    ...
    {
        String categories[] = getResources().getStringArray(R.array.category_channel_manage_video);
